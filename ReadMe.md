...
![img.png](assets/readm_me_imgs/img.png)

The application provides the following features:

- Elastic Compute Cloud (EC2) Management
    - ![img_1.png](assets/readm_me_imgs/img_1.png)
- Elastic Block Store (EBS) Management
    - ![img_10.png](assets/readm_me_imgs/img_10.png)
- Simple Storage Service (S3) Management
    - ![img_29.png](assets/readm_me_imgs/img_29.png)
- CloudWatch Monitoring and Alarms
    - ![img_40.png](assets/readm_me_imgs/img_40.png)
- Relational Database Service (RDS) Management
    - ![img_43.png](assets/readm_me_imgs/img_43.png)
...
- List all EC2 instances
    - ![img_2.png](assets/readm_me_imgs/img_2.png)
- Start an EC2 instance
    - ![img_3.png](assets/readm_me_imgs/img_3.png)
    - ![img_4.png](assets/readm_me_imgs/img_4.png)
- Stop an EC2 instance
    - ![img_5.png](assets/readm_me_imgs/img_5.png)
- Launch a new EC2 instance
    - ![img_6.png](assets/readm_me_imgs/img_6.png)
    - ![img_7.png](assets/readm_me_imgs/img_7.png)
- Terminate an EC2 instance
    - ![img_8.png](assets/readm_me_imgs/img_8.png)
    - ![img_9.png](assets/readm_me_imgs/img_9.png)
...
- List all existing EC2 volumes
    - ![img_11.png](assets/readm_me_imgs/img_11.png)
- Create a new EC2 volume
    - ![img_12.png](assets/readm_me_imgs/img_12.png)
    - ![img_13.png](assets/readm_me_imgs/img_13.png)
- Attach existing EC2 volume to an EC2 instance
    - ![img_14.png](assets/readm_me_imgs/img_14.png)
    - ![img_15.png](assets/readm_me_imgs/img_15.png)
- Detach an EC2 volume from an EC2 instance
    - ![img_16.png](assets/readm_me_imgs/img_16.png)
    - ![img_17.png](assets/readm_me_imgs/img_17.png)
- Modify an EC2 volume's capacity
    - ![img_18.png](assets/readm_me_imgs/img_18.png)
    - ![img_19.png](assets/readm_me_imgs/img_19.png)
- Delete an EC2 volume
    - ![img_20.png](assets/readm_me_imgs/img_20.png)
    - ![img_21.png](assets/readm_me_imgs/img_21.png)
- List all EC2 volume snapshots
    - ![img_22.png](assets/readm_me_imgs/img_22.png)
- Take snapshot of an EC2 volume
    - ![img_23.png](assets/readm_me_imgs/img_23.png)
    - ![img_24.png](assets/readm_me_imgs/img_24.png)
- Create a new EC2 volume from an EC2 volume snapshot
    - ![img_25.png](assets/readm_me_imgs/img_25.png)
    - ![img_26.png](assets/readm_me_imgs/img_26.png)
- Delete an EC2 volume snapshot
    - ![img_27.png](assets/readm_me_imgs/img_27.png)
    - ![img_28.png](assets/readm_me_imgs/img_28.png)
...
- List all S3 buckets
    - ![img_30.png](assets/readm_me_imgs/img_30.png)
- List all objects in a given S3 bucket
    - ![img_31.png](assets/readm_me_imgs/img_31.png)
- Upload an object to an S3 bucket
    - ![img_32.png](assets/readm_me_imgs/img_32.png)
    - ![img_33.png](assets/readm_me_imgs/img_33.png)
- Download an object from an S3 bucket
    - ![img_34.png](assets/readm_me_imgs/img_34.png)
    - ![img_35.png](assets/readm_me_imgs/img_35.png)
- Delete an S3 bucket
    - ![img_38.png](assets/readm_me_imgs/img_38.png)
    - ![img_39.png](assets/readm_me_imgs/img_39.png)
- Create a new S3 bucket
    - ![img_36.png](assets/readm_me_imgs/img_36.png)
    - ![img_37.png](assets/readm_me_imgs/img_37.png)
...
- List all RDS DB instances
    - ![img_44.png](assets/readm_me_imgs/img_44.png)
- Create a new RDS DB instance (takes a while to complete)
    - ![img_45.png](assets/readm_me_imgs/img_45.png)
    - ![img_47.png](assets/readm_me_imgs/img_47.png)
- Delete an RDS DB instance
    - ![img_48.png](assets/readm_me_imgs/img_48.png)
    - ![img_49.png](assets/readm_me_imgs/img_49.png)
- Reboot an RDS DB instance (takes a while to complete)
    - ![img_50.png](assets/readm_me_imgs/img_50.png)
- List all snapshots of RDS DB instances
    - ![img_51.png](assets/readm_me_imgs/img_51.png)
- Create a snapshot from an RDS DB instance (takes a while to complete)
    - ![img_52.png](assets/readm_me_imgs/img_52.png)
    - ![img_53.png](assets/readm_me_imgs/img_53.png)
- Delete a snapshot of an RDS DB instance
    - ![img_54.png](assets/readm_me_imgs/img_54.png)
    - ![img_55.png](assets/readm_me_imgs/img_55.png)
- Restore an RDS DB instance from a snapshot of an RDS DB instance
    - ![img_56.png](assets/readm_me_imgs/img_56.png)
    - ![img_57.png](assets/readm_me_imgs/img_57.png)